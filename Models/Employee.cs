...
namespace Examination.Models
{
    public class Employee
    {
        ...
        [MinLength(2, ErrorMessage = "You can enter only 2 letters minimum!")]
        [StringLength(180)]
        [RegularExpression(@"[a-zA-Z0-9\s]*$", ErrorMessage = "This does not like a valid second address line!")]
        ...
        [MinLength(2, ErrorMessage = "You can enter only 2 letters minimum!")]
        [StringLength(4)]
        [RegularExpression(@"^[a-zA-Z\s]*$", ErrorMessage = "This does not like a valid department code!")]
